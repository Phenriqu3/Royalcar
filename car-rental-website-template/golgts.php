...
<header class="">
    ...
    <div class="products">
        ...
        <div class="row mt-4">
                ...
                <div id="carouselFerrari" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/Carros Classicos/Gol Gts/1.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 1" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Gol Gts/2.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 2" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Gol Gts/3.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Gol Gts/4.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Gol Gts/5.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Gol Gts/6.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Gol Gts/7.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Gol Gts/8.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
            ...
            <div class="col-md-4">
                <div class="details">
                    ...
                    <p><strong><b>Modelo</b></strong> Volksvagen Gol GTS</p>
                    <p><strong><b>Ano</b></strong> 1989</p>
                    <p><strong><b>Motor</b></strong> V8 - 383</p>
                    <p><strong><b>Tipo de combustível</b></strong> Àlcool</p>
                    <p><strong><b>Quilometragem</b></strong> 85.000 km</p>
                    <p><strong><b>Transmissão</b></strong> Manual</p>          
                    <p><strong><b>Portas</b></strong> 2</p>
                    <p><strong><b>Carroceria</b></strong>Hatch</p>
                    </div> 
                    <div class="row mt-4">
                        <div class="col-md-12">
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <h4>Descrição</h4>
                <p>O Volkswagen Gol GTS é um modelo esportivo que, juntamente com o Voyage Sport, fez sucesso no mercado brasileiro entre o final dos anos 80 e meio dos anos 90. Tem uma  decoração ostensivamente esportiva e bem diferenciada em relação aos modelos convencionais.</p>
            </div>
        </div>

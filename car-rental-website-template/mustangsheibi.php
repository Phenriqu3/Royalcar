...
<body>
    ...
    <div class="products">
                ...
                <div id="carouselFerrari" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/Carros Esportivos/mustang/1.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 1" height="600px">
                        </div> 
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/3.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 2" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/4.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/5.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/6.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/7.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/8.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/9.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Esportivos/mustang/10.webp" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
            ...
            <div class="col-md-4">
                <div class="details">
                    ...
                    <div class="container mt-5">
                        <h2>Ford Mustang Shelbi GT500</h2>
                        <p>
                            <span> 2021 </span>
                    ...
                    <div class="modal-footer">
                     ...
                     <h2><b> R$ 22.000,00</b></h2>

                    <div class="info-box">
                    <p><strong><b>Marca</b></strong> Ford</p>
                    <p><strong><b>Modelo</b></strong> Ford Mustang Shelbi GT500</p>
                    <p><strong><b>Ano</b></strong> 2021</p>
                    <p><strong><b>Cor </b></strong> Branco/Azul</p>
                    <p><strong><b>Motor</b></strong> V8 770 cv</p>
                    <p><strong><b>Tipo de combustível</b></strong> Gasolina</p>
                    <p><strong><b>Quilometragem</b></strong> 2.200 km</p>
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <h4>Descrição</h4>
                <p>O Ford Mustang Shelby GT500 2021 personifica o verdadeiro espírito do poder e da elegância automotiva. É a versão mais potente da marca Mustang, sendo uma homenagem a um ex-piloto automobilístico Carroll Shelby, criador do modelo Cobra.</p>
            </div>
        </div>

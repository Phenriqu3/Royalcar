...
<body>
    ...
    <div class="products">
        ...
        <div class="row mt-4">
                ...
                <div id="carouselFerrari" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/Carros Classicos/Fusca/1-1.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 1" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Fusca/6.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 2"height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Fusca/13.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Fusca/11.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Fusca/19.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Fusca/14.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Fusca/15.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
                        <div class="carousel-item">
                            <img src="img/Carros Classicos/Fusca/3-1.jpg" class="d-block w-100" alt="Ferrari SF90 Stradale 3" height="600px">
                        </div>
            ...
            <div class="col-md-4">
                <div class="details">
                    ...
                    <div class="info-box">
                    <p><strong><b>Marca</b></strong> Volksvagen</p>
                    <p><strong><b>Modelo</b></strong> Volksvagen Fusca 1600</p>
                    <p><strong><b>Ano</b></strong> 1995</p>
                    <p><strong><b>Cor </b></strong> Bege Urano</p>
                    <p><strong><b>Motor</b></strong> 1.6 / 65 cv</p>
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <h4>Descrição</h4>
                <p> o Volkswagen Fusca 1600 de 1995 é uma representação icônica da engenharia e design automotivo clássico, combinando simplicidade, funcionalidade e um charme eterno que continua a atrair admiradores em todo o mundo, um dos carros mais icônicos e duradouros da história automotiva, com um design que permaneceu amplamente reconhecível ao longo de várias décadas.</p>
            </div>
        </div>
